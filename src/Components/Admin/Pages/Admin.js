                        ...
                        {alldata.map((content, id) => {
                           return (
                              <NavLink state={{ Content: content }}
                                 className="card mb-4 lift shadow-none background-color" key={id}>
                                 <div className="card-body px-5 py-3">
                                    <span className="row justify-content-between align-items-center">
                                       <span className="col-md-12 col-lg-3 mb-2 mb-md-0 d-flex align-items-center text-body fs-15">
                  ...
                  <span className="col-9 col-md-6 col-lg-4 text-body align-items-center">
                     <div className="row">
                        ...
                        <div className="col-sm-6 col-md-5">
                           <label className="mb-0 fs-15"><b>Status</b></label>
                           <div>{content.athleteNavigation.blocked == false ? <span className="text-success text-white rounded-pill fs-14 mb-0  d-inline-block fw-bold text-center">Activated</span> : <span className="text-danger text-white rounded-pill fs-14 mb-0  d-inline-block fw-bold text-center">Deactivated</span>}</div>
                        </div>
                        ...
                        <div className="col-sm-6 col-md-3">
                           <label className="fs-15"><b>Action</b></label>
