  ...
  return (
    <>
      <header className="wrapper bg-soft-primary position-absolute w-100 ">
        <nav
          id="navbar"
          className="navbar navbar-expand-lg fancy navbar-light navbar-bg-light caret-none"
        >
          <div className="container">
            <div className="navbar-collapse-wrapper bg-white d-flex flex-row flex-nowrap w-100 justify-content-between align-items-center">
              ...
              <div
                id="offcanvas-start"
                className="navbar-collapse offcanvas offcanvas-nav offcanvas-start bg-white"
              >
